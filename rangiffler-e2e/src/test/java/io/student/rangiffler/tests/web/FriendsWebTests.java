...
public class FriendsWebTests extends BaseTest {
    ...
    public void friendShouldBePresentInFriendsTable(@UserType(WITH_FRIEND) TestUser user) {
...
//    @DisabledByIssue("3")
    public void friendsTableShouldBeEmptyForNewUser(@UserType(EMPTY) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .checkTravelPageIsOpen()
    ...
    public void incomeInvitationBePresentInFriendsTable(@UserType(WITH_INCOME_REQUEST) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .checkTravelPageIsOpen()
    ...
    public void outcomeInvitationBePresentInAllPeoplesTable(@UserType(WITH_OUTCOME_REQUEST) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .checkTravelPageIsOpen()
    ...
    public void acceptFriendRequest(@UserType(WITH_INCOME_REQUEST) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .clickPeopleBtn()
    ...
    public void sendFriendRequest(@UserType(STRANGER) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .clickPeopleBtn()
    ...
    public void declineFriendRequest(@UserType(WITH_INCOME_REQUEST) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .clickPeopleBtn()
    ...
    public void removeFriend(@UserType(WITH_FRIEND) TestUser user) {
        Selenide.open(CFG.frontUrl(), LoginPage.class)
                .clickLoginBtn()
                .login(user.username(), user.password())
                .clickPeopleBtn()
