...
public class FeedQueryController {
    ...
    public Slice<Photo> photos(User user,
        ...
        var mockPhoto = Photo.newBuilder()
                .id(UUID.randomUUID().toString())
                .src(photo)
                .country(Country.newBuilder().code("ru")
